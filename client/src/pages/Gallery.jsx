...
const Gallery = () => {
  ...
  return (
    <div className="min-h-screen p-8" style={{ background: "linear-gradient(to bottom, #f5f3ff, #ede9fe)" }}>
      <div className="max-w-7xl mx-auto">
        <h1 className="text-4xl font-bold text-center mb-10 text-Black relative">
          <span className="relative inline-block">
            Gallery
            <span className="absolute -bottom-2 left-0 w-full h-1 bg-black/70 rounded"></span>
          </span>
        </h1>
      ...
      {selectedItem && (
        <div className="fixed inset-0 bg-[#433878]/80 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={closeModal}>
          <div 
          ...
          >
            <div className="relative bg-white">
              ...
              />
              <button 
                className="absolute top-2 right-2 bg-[#7E60BF]/80 text-white hover:bg-[#7E60BF] rounded-full p-2 transition-colors"
                onClick={closeModal}
              >
