...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8" style={{ background: "linear-gradient(135deg, #433878 0%, #7E60BF 35%, #E4B1F0 75%, #FFE1FF 100%)" }}>
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-12">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row">
          {/* Contact Information */}
          <div className="md:w-1/3 p-8 text-white flex flex-col justify-between" style={{ background: "linear-gradient(to bottom, #433878, #7E60BF)" }}>
            <div>
              <h2 className="text-2xl font-bold mb-6">Contact Information</h2>
              <p className="mb-6 opacity-75">Have questions or feedback? We're here to help.</p>
              ...
              <div className="space-y-6">
                <div className="flex items-center">
                  ...
                  <span className="ml-4 text-purple-100">kumarsinghabhay77@gmail.com</span>
                </div>
                <div className="flex items-center">
                  <Phone className="h-6 w-6 text-purple-200" />
                  <span className="ml-4 text-purple-100">+91 7067328563</span>
                </div>
                <div className="flex items-center">
                  <MapPin className="h-6 w-6 text-purple-200" />
                  <span className="ml-4 text-purple-100">Startup Enclave, CSIT Campus, Durg, Chhattisgarh</span>
                </div>
              </div>
            </div>
          ...
          <div className="md:w-2/3 p-8">
            <div className="flex items-center mb-6">
              <MessageSquare className="h-8 w-8" style={{ color: "#433878" }} />
              <h2 className="text-2xl font-bold text-gray-800 ml-2">Send us a message</h2>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button 
                ...
                style={{ background: "linear-gradient(to right, #433878, #7E60BF)", 
                         boxShadow: "0 4px 6px rgba(67, 56, 120, 0.25)" }}
                onMouseOver={(e) => e.currentTarget.style.background = "linear-gradient(to right, #3A3169, #7055AB)"}
                onMouseOut={(e) => e.currentTarget.style.background = "linear-gradient(to right, #433878, #7E60BF)"}
              >
                <Send className="w-5 h-5" />
                <span>Send Message</span>
              </button>
